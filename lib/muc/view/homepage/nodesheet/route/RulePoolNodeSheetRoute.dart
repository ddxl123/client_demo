...
class RulePoolNodeSheetRoute extends NodeSheetRouteEntryBase<MPnRule, MFRule> {
  RulePoolNodeSheetRoute(MPnRule poolNodeModel) : super(poolNodeModel);
...
class _MoreRoute extends MoreRouteBase {
  ...
  final RulePoolNodeSheetRoute currentSheetRoute;
