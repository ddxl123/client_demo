...
import 'package:demo/muc/view/homepage/nodesheet/similar/LongPressFragmentBase.dart';
import 'package:demo/muc/view/homepage/nodesheet/similar/MoreRouteBase.dart';
...
class FragmentPoolNodeSheetRoute extends NodeSheetRouteEntryBase<MPnFragment, MFFragment> {
  FragmentPoolNodeSheetRoute(MPnFragment poolNodeModel) : super(poolNodeModel);
...
class _MoreRoute extends MoreRouteBase {
  ...
  FragmentPoolNodeSheetRoute currentSheetRoute;
