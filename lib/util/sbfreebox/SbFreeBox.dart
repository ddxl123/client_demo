...
class SbFreeBox extends StatefulWidget {
  const SbFreeBox({
    ...
    required this.fixedLayerWidgets,
          ...
          boxWidth != double.maxFinite && boxHeight != double.maxFinite,
        );
...
class _FreeBox extends State<SbFreeBox> with TickerProviderStateMixin {
  ...
  void initSliding() {
    widget.sbFreeBoxController.inertialSlideAnimationController =
        AnimationController(vsync: this);
    widget.sbFreeBoxController.targetSlideAnimationController =
        AnimationController(vsync: this);
    ...
    WidgetsBinding.instance!.addPostFrameCallback((Duration timeStamp) {
      widget.sbFreeBoxController.targetSlide(
      ...
      child: Container(
        ...
        child: GestureDetector(
          ...
          child: Transform.translate(
            offset: widget.sbFreeBoxController.offset,
            child: Transform.scale(
              alignment: Alignment.topLeft,
              scale: widget.sbFreeBoxController.scale,
              // [内容物s]
              child: StatefulBuilder(
                builder: (BuildContext context,
                    void Function(void Function()) nrwSetState) {
                  return Container(
  ...
  Positioned _fixedLayer() {
    return Positioned(
      ...
      child: StatefulBuilder(
        builder:
            (BuildContext context, void Function(void Function()) flSetState) {
