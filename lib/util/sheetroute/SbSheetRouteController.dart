...
class SbSheetPageController<T> extends ChangeNotifier {
  ...
  /// [SbSheetRoute.headerSliver] 中的 setState。
  late final Function headerSetState;

  /// [SbSheetRoute.bodySliver] 中的 setState。
  late final Function bodySetState;

  /// [SbSheetRoute.loadArea] 中的 setState。
  ...
  /// ```
  /// [removeRoute] 后,会调用 [SbSheetRoute.dispose]。
  ///
  /// 不能使用 [pop] ,因为当 [SbSheetRoute] 已被打开时，再打开新的 [SbSheetRoute] 时， [pop] 的话会把新打开的 [SbSheetRoute] 给 [pop] 了,而并不会把旧 [SbSheetRoute] 关闭。
