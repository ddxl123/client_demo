class ParseIntoSqls {
  ...
  'f_complete': 'CREATE TABLE f_complete (id INTEGER PRIMARY KEY AUTOINCREMENT,aiid INTEGER,uuid TEXT,created_at INTEGER,updated_at INTEGER,title TEXT,node_aiid INTEGER,node_uuid TEXT)',
  ...
  'f_rule': 'CREATE TABLE f_rule (id INTEGER PRIMARY KEY AUTOINCREMENT,aiid INTEGER,uuid TEXT,created_at INTEGER,updated_at INTEGER,title TEXT,node_aiid INTEGER,node_uuid TEXT)',
  ...
  'f_fragment': 'CREATE TABLE f_fragment (id INTEGER PRIMARY KEY AUTOINCREMENT,aiid INTEGER,uuid TEXT,created_at INTEGER,updated_at INTEGER,title TEXT,node_aiid INTEGER,node_uuid TEXT)',
  ...
  'f_memory': 'CREATE TABLE f_memory (id INTEGER PRIMARY KEY AUTOINCREMENT,aiid INTEGER,uuid TEXT,created_at INTEGER,updated_at INTEGER,title TEXT,node_aiid INTEGER,node_uuid TEXT)'
};
}
